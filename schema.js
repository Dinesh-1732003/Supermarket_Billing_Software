...
//         // Insert all stocks into the database
//         const insertedStock = await Stock.insertMany(allStock);

//         // Iterate through each inserted stock and save it
//         const savedStock = [];
//         for (const stock of insertedStock) {
//             const savedDoc = await stock.save();
//             savedStock.push(savedDoc);
//         }
